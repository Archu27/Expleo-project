package com.ChallengingDom.testcases;
...
import com.ChallengingDom.Pages.TestPage;
import com.ChallengingDom.base.TestBase;

public class ChallengingDomPageTest extends TestBase{

	TestPage cdp;
	
	public ChallengingDomPageTest(){         //calling the constructor
		super();                            //to inherit the constructor of super class test
	...
	// Setup
		...
		public void setup() {
			initialization();
			cdp = new TestPage();       // created this object to access all the function of test page
		}
		...
		public void validateHeaderTest() {
			String header = cdp.validateHeaderText();
		...
		// Test that checks the headers of the table
		@Test(priority = 6)
